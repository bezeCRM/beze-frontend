...
export function useOrderCreateForm() {
    const defaultValues: OrderCreateFormValues = useMemo(
        () => ({
            name: '',
            clientName: '',
            clientPhone: '',
    ...
    function setPickup(value: boolean) {
        form.setValue('delivery.isPickup', value, { shouldValidate: true })
        if (value) {
            form.setValue('delivery.address', '', { shouldValidate: true })
        }
    }

    function setPaymentStatus(value: OrderPaymentStatus) {
        form.setValue('paymentStatus', value, { shouldValidate: true })
    }
    ...
    function togglePlanner(value: boolean) {
        form.setValue('inPlanner', value, { shouldValidate: true })
    }
    ...
    function addItem(product: Product, filling?: Filling) {
        ...
        // объединяем только товары в штуках
