      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={{ }}>
          <View style={styles.headerWrap}>
            <InternalHeader title="Добавление товара" onBack={() => navigation.goBack()} />
          </View>
          ...
          <SectionCard title="Цена">
            <TextInput
              value={price}
              onChangeText={(t) => setValue('price', t, { shouldValidate: true })}
              placeholder={unit === 'piece' ? 'Введите цену за 1 шт' : 'Введите цену за 1 кг'}
              placeholderTextColor={theme.colors.mainGray}
